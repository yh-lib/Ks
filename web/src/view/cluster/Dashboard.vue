...
const dashboardMap = {
  'cluster-01': {
    ...
    events: [
      ...
      { time: '10:18', type: 'Warning', reason: 'Unhealthy', message: 'prod-node-04 存在短暂网络抖动' },
      { time: '09:50', type: 'Normal', reason: 'ScalingReplicaSet', message: '前端工作负载完成扩容' },
    ],
  },
  'cluster-02': {
    clusterInfo: {
    ...
    events: [
      { time: '11:05', type: 'Normal', reason: 'NodeReady', message: 'stage-node-03 完成维护后恢复' },
      { time: '10:41', type: 'Warning', reason: 'BackOff', message: 'qa 命名空间中的某个 Pod 拉起失败' },
  ...
  'cluster-03': {
    ...
    events: [
      { time: '09:58', type: 'Normal', reason: 'NodeReady', message: '开发节点完成重启并恢复正常' },
      { time: '09:34', type: 'Normal', reason: 'Created', message: '新版本服务已部署到开发集群' },
      { time: '08:59', type: 'Warning', reason: 'Evicted', message: '一个临时 Pod 因资源不足被驱逐' },
    ],
  },
}
