...
const getConfigMapList = () => {   
    getConfigMapListHandler(workLoadItem.value.clusterId,workLoadItem.value.nameSpace).then((res)=>{
        ...
        <el-tabs>
            <el-tab-pane label="基础配置">
                ...
                <el-form-item label="configMap" prop="configMap.name">
                    <el-select v-model="data.volumeItem.configMap.name" placeholder="请选择要挂载的configMap" @visible-change="getConfigMapList">
                        <el-option
                ...
                <el-table :data="data.volumeItem.configMap.items">
                    <el-table-column prop="key" label="Key" width="200px">
                        <template #default="scope">
                            <el-form-item label="" label-width="0px" :prop="('configMap.items.'+scope.$index+'.key')" :rules="rules.items.key">
                    ...
                    <el-table-column prop="path" label="挂载路径">
                        <template #default="scope">
                            <el-form-item label="" label-width="0px" :prop="('configMap.items.'+scope.$index+'.path')" :rules="rules.items.path">
                    ...
                    <el-table-column prop="mode" label="挂载权限" width="200px">
                        <template #default="scope">
                            <el-form-item label="" label-width="0px" :prop="('configMap.items.'+scope.$index+'.mode')" :rules="rules.items.mode">
