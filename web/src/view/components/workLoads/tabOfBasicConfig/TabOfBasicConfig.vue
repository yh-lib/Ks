...
const data = reactive({
    ...
    // 选项
    dnsPolicyList:[{value:'Default'},{value:'ClusterFirst'},{value:'ClusterFirstWithHostNet'}],
...
const deleteControllerLabelItem = (index) => {data.controllerLabelsList.splice(index,1)}
// 控制器注释
const addControllerAnnotationItem = () => {data.controllerAnnotationsList.unshift({key:"",value:""})}
const deleteControllerAnnotationItem = (index) => {data.controllerAnnotationsList.splice(index,1)}
// 切换更新策略
        ...
        <template #mainData>
            ...
            <el-row :gutter="100">
                ...
                <el-form-item label="名称" required>
                    <el-input placeholder="请输入资源名称" v-model="workLoadItem.item.metadata.name" @change="syncToWorkLoadItemName"/>
                </el-form-item>
                </el-col>
                <!-- 副本数 -->
                <el-col :span="8" class="form-item">
                <el-form-item label="副本数" >
                    <el-input placeholder="请输入副本数" v-model.number="workLoadItem.item.spec.replicas"/>
                </el-form-item>
                </el-col>
                <!-- 镜像地址 -->
                <el-col :span="8" class="form-item">
                <el-form-item label="镜像地址" required>
                    <el-input placeholder="请输入镜像地址" v-model="workLoadItem.item.spec.template.spec.containers[0].image" />
                </el-form-item>
                </el-col>
                <!-- 镜像拉取策略 -->
                <el-col :span="8" class="form-item">
                <el-form-item label="镜像拉取策略">
                    <el-select placeholder="请选择镜像拉取策略" v-model="workLoadItem.item.spec.template.spec.containers[0].imagePullPolicy">
                    <el-option 
            ...
            <el-col :span="8" class="form-item">
                ...
                <el-select placeholder="请选择 DNS 策略" v-model="workLoadItem.item.spec.template.spec.dnsPolicy">
                    <el-option 
            ...
            <el-col :span="8" class="form-item">
                ...
                <el-select placeholder="请选择更新策略" v-model="workLoadItem.item.spec.strategy.type" @change="updatePoicySwitchFunc">
                    <el-option 
            ...
            <!-- 更新策略 参数 -->
            <el-col :span="8" class="form-item">
                <div style="display: flex;justify-content: space-between;" v-if="workLoadItem.item.spec.strategy.type=='RollingUpdate'">
                <el-form-item label="最大不可用" label-width="100px">
                    <el-input placeholder="" style="width: 100px" v-model="workLoadItem.item.spec.strategy.rollingUpdate.maxUnavailable"/>
                </el-form-item>
                <el-form-item label="可超出最大值" label-width="100px">
                    <el-input placeholder="" style="width: 100px" v-model="workLoadItem.item.spec.strategy.rollingUpdate.maxSurge"/>
                </el-form-item>
                </div>
            </el-col>          
            <!-- 使用宿主机网络 -->
